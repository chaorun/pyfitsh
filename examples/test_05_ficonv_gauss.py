#!/usr/bin/env python3
"""test_05: ficonv gauss multi-kernel 对比"""
...
def do_test():
    ...
    fc = Ficonv(kernel='i/0;b/1;g=3,1.0,2/0;g=5,2.0,2/0;g=7,4.0,2/0',
                iterations=3, rejection_level=3)
    ...
    ok1, msg1 = compare_fits(convolved, "cli_test_ref_conv_gauss.fits")
    if not ok1:
        return False, f"convolved: {msg1}"

    ok2, msg2 = compare_fits(subtracted, "cli_test_sub_gauss.fits")
    if not ok2:
