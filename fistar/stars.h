...
int	fit_small_parabola_point(image *img,int x,int y,double *fit);
int	fit_small_parabola_block(image *img,int x,int y,double *fit);
int	fit_small_parabola_block_param(image *img,int j,int i,double *rcx,double *rcy,double *raxx,double *raxy,double *rayy,double *rpeak);
...
int	refine_candidate_params(image *img,candidate *cands,int ncand);
...
int	fit_star_single_model(image *img,char **mask,candidate *cands,int ncand,
		star **rstars,int *rnstar,starfit *fgp,int model,int modelorder);

#ifdef	STAR_MULTIMODEL
int	fit_star_multi_models(image *img,char **mask,candidate *cands,int ncand,
		star **rstars,int *rnstar,starfit *fgp,starmodelfit *smfs,int nsmf);
int	fit_star_model(image *img,char **mask,candidate *cands,int ncand,
		star **rstars,int *rnstar,starfit *fgp,int model,int modelorder);
#endif

int	collective_fit_star_single_model(image *img,char **mask,
		star *stars,int nstar,ipointlist *ipl,
		starfit *sfp,int is_putback,int level);
int	collective_fit_star_single_model_iterative(image *img,char **mask,
		star *stars,int nstar,ipointlist *ipl,
		starfit *sfp,int level,int niter);
int	collective_fit_star_single_model_blocked(image *img,char **mask,
...
int	fit_star_psf_native(image *img,char **mask,candidate *cands,int ncand,
		star **rstars,int *rnstar,psffit *pfp,psf *tpd);

int	fit_star_psf(image *img,char **mask,candidate *cands,int ncand,
		star **rstars,int *rnstar,psffit *pfp,psf *tpd);

/* star-cand-pp.c */ /********************************************************/
int	search_star_candidates(image *img,char **mask,
	candidate **rcands,int *rncand,range *srcrange,
	double threshold,spatial *bg,double skysigma);

int	markout_candidates(image *img,char **mask,candidate *cands,int ncand);

/* star-cand-biq.c */ /*******************************************************/

int	search_star_candidates_biquad(image *img,char **mask,
	candidate **rcands,int *rncand,range *srcrange);

/* star-cand-trb.c */ /*******************************************************/
int	search_star_candidates_trb(image *img,char **mask,
	candidate **rcands,int *rncand,range *srcrange,
	double treshold);

/* star-cand-lnk.c */ /*******************************************************/
int	search_star_candidates_link(image *img,char **mask,
	candidate **rcands,int *rncand,range *srcrange,
