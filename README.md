...
| test_lfit_montecarlo.sh | 19 | MCMC/XMMC/EMCE/FIMA (含 weighted/derived/perturb) | 19/19 PASS |
| longtest_lfit.sh | 9 | 长迭代 MCMC/XMMC/EMCE/FIMA (20000 iterations) | 9/9 PASS |
...
- 新增 `lfit` 模块：通用曲线拟合，完整复刻 9 种方法，47/47 测试 PASS，参数对标 `--long-help`
