...
class Fitrans:
    ...
    def Convolution(kernel=None, iterations=0, rejection_level=3.0,
        ...
        """
        return ConvolutionOp(kernel, iterations, rejection_level,
