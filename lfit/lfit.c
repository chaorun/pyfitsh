...
#ifndef	HOST_WIN32
// #define	LFIT_ENABLE_DYNAMIC_EXTENSIONS		1  // disabled for pyfitsh
#endif
...
static int fprint_error(char *expr,...)
{
 va_list	ap;
...
static int fprint_warning(char *expr,...)
{
 va_list	ap;
